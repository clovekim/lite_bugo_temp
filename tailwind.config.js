  ...
  theme: {
    ...
    extend: {
      ...
      gridTemplateColumns: {
        ...
        'bugo-message-sender': `minmax(0, 0.5fr) minmax(0, 0.8fr) minmax(0, 1fr) minmax(0, 1.5fr) minmax(0, 1.4fr) minmax(0, 2.5fr) minmax(0, 2.0fr) minmax(0, 2fr) minmax(0, 3fr) minmax(0, 1.5fr)`,
      },
      gridTemplateRows: {
        'auto-1fr': 'auto 1fr',
